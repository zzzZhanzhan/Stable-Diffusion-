...
def _binary_to_hex(binary_list):
    ...
    for i in range(0, len(binary_list), 4):
        ...
        hex_char = hex(int(chunk_str, 2))[2:]
        hex_str += hex_char
    return hex_str
